    ...
    function HTTP_Upload_Error($lang = null, $html = false)
    {
        ...
        $this->error_codes = array(
            'TOO_LARGE' => array(
				...
				'pt' 	=> "Ficheiro muito grande. O tamanho m&aacute;ximo permitido &eacute; $maxsize bytes.",
                ),
            'MISSING_DIR' => array(
				...
				'pt' 	=> 'Aus&ecirc;ncia de pasta de destino.'
                ),
            'IS_NOT_DIR' => array(
				...
				'pt' 	=> 'A pasta de destino n&atilde;o existe ou &eacute; um ficheiro.',
                ),
            'NO_WRITE_PERMS' => array(
				...
				'pt' 	=> 'A pasta de destino n&atilde;o possui permiss&atilde;o de escrita.'
                ),
            'NO_USER_FILE' => array(
				...
				'pt' 	=> 'Não foi seleccionado um ficheiro para upload.'
                ),
            'BAD_FORM' => array(
				...
				'pt' 	=> 'O formul&aacute;rio HTML n&atilde;o possui o method="post" enctype="multipart/form-data" requerido.'
                ),
            'E_FAIL_COPY' => array(
				...
				'pt' 	=> 'Erro ao copiar o ficheiro tempor&aacute;rio.'
                ),
            'E_FAIL_MOVE' => array(
				...
				'pt' 	=> 'N&atilde;o foi poss&iacute;vel mover o ficheiro.',
                ),
            'FILE_EXISTS' => array(
                ...
                'pt' 	=> 'O ficheiro de destino j&aacute; existe.'
                ),
            'CANNOT_OVERWRITE' => array(
				...
				'pt' 	=> 'O ficheiro de destino j&aacute; existe e n&atilde;o p&ocirc;de ser sobrescrito.'
                ),
            'NOT_ALLOWED_EXTENSION' => array(
				...
				'pt' 	=> 'Extens&atilde;o de ficheiro n&atilde;o permitida.',
                ),
            'PARTIAL' => array(
				...
				'pt' 	=> 'O ficheiro não foi completamente enviado.'
                ),
            'ERROR' => array(
                'es'    => 'Error en subida:',
                'en'    => 'Upload error:',
            ...
            'DEV_NO_DEF_FILE' => array(
				...
				'pt_BR' => 'O nome de arquivo n&atilde;o est&aacute; definido no formul&aacute;rio como &lt;input type="file" name=?&gt;.',
				'pt_BR' => 'O nome de ficheiro n&atilde;o est&aacute; definido no formul&aacute;rio como &lt;input type="file" name=?&gt;.'
                )
        );
    }
